...
Two module paths are available in Neurodesk. Both run the same underlying
SynthStrip model and use the `mri_synthstrip` command; choose based on what is
already loaded.
...
## Path B: SynthStrip Standalone Module
...
No FreeSurfer licence required.
